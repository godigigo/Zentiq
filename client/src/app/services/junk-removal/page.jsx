...
const services = [
  {
    ...
    short: "Clearing unwanted household items",
    category: "Home",
    body:
      "We help remove unwanted household items so your living space feels lighter, cleaner, and easier to manage. From general clutter to bulky belongings, our team handles the removal process with care.",
    detail: [
      "Furniture and appliance removal",
      "General household clutter clearing",
      "Convenient home clean-out support",
    ],
  },
  {
    id: "office",
    title: "Office & commercial removal",
    short: "Clearing workspaces and business clutter",
    category: "Commercial",
    body:
      "For offices, retail spaces, and commercial areas, we remove unwanted items efficiently so spaces can be cleaned up, reorganized, or prepared for their next use.",
    detail: [
      "Office furniture removal",
      "Workspace clearing support",
      "Commercial clean-out assistance",
    ],
  },
  {
    id: "debris",
    title: "Construction debris removal",
    short: "Handling leftover renovation waste",
    category: "Debris",
    body:
      "Construction and renovation sites often leave behind materials that need proper clearing. We help remove leftover debris so the space feels more usable, safer, and easier to manage.",
    detail: [
      "Renovation debris removal",
      "Post-project material clearing",
      "Site clean-up support",
    ],
  },
  {
    id: "yard",
    title: "Yard waste removal",
    short: "Outdoor clean-up for unwanted waste",
    category: "Outdoor",
    body:
      "We assist with yard waste removal so outdoor spaces stay tidier and easier to maintain. This includes help with loose waste, seasonal clean-up, and general outdoor clearing.",
    detail: [
      "Seasonal outdoor clean-up",
      "Loose yard waste collection",
      "Cleaner and more manageable spaces",
    ],
  },
  {
    id: "ewaste",
    title: "E-waste recycling support",
    short: "Responsible handling for electronics",
    category: "Electronics",
    body:
      "Old electronics need to be handled more carefully than standard waste. We help remove and sort electronic items so they can be handled more responsibly and appropriately.",
    detail: [
      "Electronics collection support",
      "Careful handling of devices",
      "More responsible disposal approach",
    ],
  },
  {
    id: "donation",
    title: "Donation pickup support",
    short: "Giving reusable items a second life",
    category: "Donation",
    body:
      "Some items no longer needed in your space may still be useful to others. We help separate and remove reusable belongings so they can be prepared for donation where appropriate.",
    detail: [
      "Reusable item pickup",
      "Donation-ready item separation",
      "Cleaner, more thoughtful decluttering",
    ],
  },
];
...
export default function JunkRemovalServicesPage() {
  const pageRef = useRef(null);
  const cursorRef = useRef(null);
  const spotlightRef = useRef(null);
  const magneticRefs = useRef([]);
  const [openId, setOpenId] = useState("residential");
          ...
          <div className="flex flex-col gap-10 lg:flex-row lg:items-end lg:justify-between">
            <div>
              ...
              >
                ...
                <span>/</span>
                <span className="text-white/70">Junk Removal Services</span>
              </nav>

              <h1
                data-h-title
                className={`${unbounded.className} max-w-[11ch] text-[clamp(3.2rem,7vw,6.8rem)] font-[500] leading-[0.88] tracking-[-0.07em] text-white`}
              >
              ...
              >
                Professional junk removal support for cleaner spaces, responsible
                disposal, and a more organized, clutter-free environment.
              </p>
            </div>

            <div data-h-cta className="flex flex-col items-start gap-6 lg:items-end">
              <div className="relative h-10 w-[255px] overflow-hidden">
                {benefits.map((b, i) => (
                  <div
                    key={b}
          ...
          <div className="grid gap-14 lg:grid-cols-[280px_1fr] lg:gap-16 xl:grid-cols-[320px_1fr]">
            <div className="lg:sticky lg:top-28 lg:self-start">
              <div data-reveal>
                ...
                >
                  Removal support for homes, workspaces, and more
                </h2>
                <p className="mt-5 text-[14px] leading-[1.88] text-white/62">
                  Open each section to see what is included in our junk removal
                  service and how we help clear out unwanted items more efficiently.
                </p>
          ...
          >
            ...
            <div className="relative z-10 flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
              <div>
                ...
                >
                  Let's plan your junk removal
                </h2>
                <p className="mt-4 max-w-[52ch] text-[15px] leading-[1.85] text-white/64">
                  Tell us what needs to go and we’ll help you arrange the right
                  removal support for a cleaner, more manageable space.
                </p>
              </div>
