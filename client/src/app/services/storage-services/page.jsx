...
const services = [
  {
    id: "residential",
    title: "Residential storage options",
    short: "Space for household belongings",
    category: "Home",
    body:
      "Our residential storage solutions help keep household items secure when you need extra space during moving, renovation, downsizing, or temporary transitions.",
    detail: [
      "Storage for household belongings",
      "Short or extended storage support",
      "Helpful during home transitions",
    ],
  },
  {
    id: "commercial",
    title: "Commercial business storage",
    short: "Flexible storage for business items",
    category: "Business",
    body:
      "We provide storage support for business inventory, office materials, furniture, equipment, and other commercial belongings that need a secure place for temporary or ongoing storage.",
    detail: [
      "Business inventory storage",
      "Office and workspace item holding",
      "Flexible support for operations",
    ],
  },
  {
    id: "temporary",
    title: "Temporary storage periods",
    short: "Short-term storage during transitions",
    category: "Short-term",
    body:
      "Short-term storage is ideal when you need a temporary place for belongings during move coordination, renovations, delayed move-ins, or other in-between situations.",
    detail: [
      "Useful during short transitions",
      "Temporary storage flexibility",
      "Extra space when timing shifts",
    ],
  },
  {
    id: "longterm",
    title: "Long-term storage solutions",
    short: "Reliable storage for extended needs",
    category: "Long-term",
    body:
      "For items that need to stay stored for a longer period, our long-term storage support helps keep belongings protected, organized, and available when needed.",
    detail: [
      "Extended storage options",
      "Organized long-term holding",
      "Suitable for valuable belongings",
    ],
  },
  {
    id: "security",
    title: "Protected storage environment",
    short: "Added care for stored belongings",
    category: "Security",
    body:
      "We focus on maintaining a dependable storage environment so belongings stay protected while in storage, with care given to overall security and item condition.",
    detail: [
      "Secure storage approach",
      "Protection-minded handling",
      "Peace of mind for stored items",
    ],
  },
  {
    id: "logistics",
    title: "Storage & transportation support",
    short: "Moving items in and out with ease",
    category: "Logistics",
    body:
      "When storage is part of a larger move, we help coordinate transportation and storage together so belongings can be moved, stored, and returned more smoothly.",
    detail: [
      "Storage tied to moving services",
      "Easier item coordination",
      "Support for pickup and return flow",
    ],
  },
];
        ...
        <div className="site-container relative z-10 py-16 md:py-22">
          <div className="flex flex-col gap-10 lg:flex-row lg:items-end lg:justify-between">
            <div>
              ...
              >
                Secure and flexible storage solutions for short-term and long-term
                needs, with dependable support when extra space is needed.
              </p>
            </div>
          ...
          <div className="grid gap-14 lg:grid-cols-[280px_1fr] lg:gap-16 xl:grid-cols-[320px_1fr]">
            <div className="lg:sticky lg:top-28 lg:self-start">
              <div data-reveal>
                ...
                >
                  Storage solutions designed for flexibility and peace of mind
                </h2>
                <p className="mt-5 text-[14px] leading-[1.88] text-white/62">
                  Open each section to explore the storage services we provide and
                  how they support household, business, and transitional needs.
                </p>
          ...
          >
            ...
            <div className="relative z-10 flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
              <div>
                ...
                >
                  Let's plan your storage solution
                </h2>
                <p className="mt-4 max-w-[52ch] text-[15px] leading-[1.85] text-white/64">
                  Tell us what you need to store and we’ll help you choose the
                  right storage support for your timeline, space needs, and move.
                </p>
              </div>
