...
const benefits = [
  ...
  "Organized packing process",
  "Move-ready preparation",
...
const services = [
  {
    ...
    short: "Wrapped and secured for safer transport",
    category: "Protection",
    body:
      "Large and delicate furniture is carefully wrapped using protective materials that help reduce scratches, dents, and surface damage during moving and handling.",
    detail: [
      "Blanket and wrap protection",
      "Edge and surface coverage",
      "Prepared for loading and transport",
    ],
  },
  {
    id: "fragile",
    title: "Fragile item packing",
    short: "Extra care for breakable belongings",
    category: "Fragile",
    body:
      "Glassware, dishes, décor, and delicate household items are packed with a more careful method using added protection and thoughtful placement inside each box.",
    detail: [
      "Extra cushioning for breakables",
      "Secure inner-box arrangement",
  ...
  },
  {
    ...
    short: "Organized prep for sensitive equipment",
    category: "Electronics",
    body:
      "TVs, monitors, office electronics, and devices are packed with care so they stay protected, organized, and easier to unpack once the move is complete.",
    detail: [
      "Protective wrapping for devices",
      "Cable and accessory organization",
      "Prepared for safer transport",
    ],
  },
  {
    id: "artwork",
    title: "Artwork & mirror packing",
    short: "Special handling for valuable surfaces",
    category: "Specialty",
    body:
      "Artwork, mirrors, frames, and decorative pieces require a more precise packing approach. We use reinforced protection methods to help reduce cracks, chips, and surface wear.",
    detail: [
      "Special wrap and corner protection",
      "Dedicated packing approach",
      "Safer handling for delicate surfaces",
    ],
  },
  {
    id: "bulky",
    title: "Bulky item preparation",
    short: "Managed packing for awkward items",
    category: "Handling",
    body:
      "Oversized and awkward household items are prepared with the right packing strategy before loading, making them easier to handle and more secure during the move.",
    detail: [
      "Awkward-shape packing support",
      "Protective preparation before loading",
      "Safer handling and movement",
    ],
  },
  {
    id: "custom",
    title: "Custom packing support",
    short: "Flexible packing based on your needs",
    category: "Custom",
    body:
      "Whether you need full-home packing or help only with selected rooms and valuable belongings, we tailor the packing service to fit the level of support you need.",
    detail: [
      "Full or partial packing options",
      "Room-by-room flexibility",
      "Support matched to your move",
    ],
  },
];
...
export default function PackingServicesPage() {
  ...
  const [openId, setOpenId] = useState("furniture");
        ...
        <div className="site-container relative z-10 py-16 md:py-22">
          <div className="flex flex-col gap-10 lg:flex-row lg:items-end lg:justify-between">
            <div>
              ...
              >
                Professional packing support with careful preparation, protective
                materials, and organized handling for a smoother move.
              </p>
            </div>

            <div data-h-cta className="flex flex-col items-start gap-6 lg:items-end">
              <div className="relative h-10 w-[250px] overflow-hidden">
                {benefits.map((b, i) => (
                  <div
                    key={b}
          ...
          <div className="grid gap-14 lg:grid-cols-[280px_1fr] lg:gap-16 xl:grid-cols-[320px_1fr]">
            <div className="lg:sticky lg:top-28 lg:self-start">
              <div data-reveal>
                ...
                >
                  Packing support for every type of item
                </h2>
                <p className="mt-5 text-[14px] leading-[1.88] text-white/62">
                  Open each section to see what is included in our packing
                  services and how we help prepare your belongings for a safer move.
                </p>
          ...
          >
            ...
            <div className="relative z-10 flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
              <div>
                ...
                >
                  Let's plan your packing service
                </h2>
                <p className="mt-4 max-w-[52ch] text-[15px] leading-[1.85] text-white/64">
                  Tell us what needs packing and we’ll help you choose the right
                  level of support for a well-prepared, stress-free move.
                </p>
              </div>
